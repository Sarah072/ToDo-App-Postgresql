     ...
     <div className="relative z-10">
      ...
      <div className="flex flex-col items-center">
        {list.map((task, index) => (
          <div
            key={index}
            className="flex justify-between items-start bg-white py-3 px-3 rounded border border-gray-400 lg:w-[30%] w-80 sm:w-[50%]"
            ...
            <div>
              <label className="flex items-center">
                <input
                  ...
                  className="rounded-full h-5 w-5 border-purple-600 focus:ring-purple-500 checked:bg-purple-600 checked:border-transparent"
                />
